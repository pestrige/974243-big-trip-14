...
const createTripPointFullElement = (point) => {
  const {
    basePrice,
    dateFrom,
    dateTo,
  ...
  <input class="event__offer-checkbox  visually-hidden" id="event-offer-${getIdName()}" type="checkbox" name="event-offer-${getIdName()}">
  ...
  <form class="event event--edit" action="#" method="post">
    <header class="event__header">
      ...
      <div class="event__field-group  event__field-group--time">
        ...
        <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${humanizeDate(dateFrom, DateType.FULL)}">
        &mdash;
        <label class="visually-hidden" for="event-end-time-1">To</label>
        <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${humanizeDate(dateTo, DateType.FULL)}">
      </div>
...
export default class TripPointFull extends AbstractView {
  constructor(point) {
    super();
    this._point = point;
  }
  ...
  getTemplate() {
    return createTripPointFullElement(this._point);
  }
}
